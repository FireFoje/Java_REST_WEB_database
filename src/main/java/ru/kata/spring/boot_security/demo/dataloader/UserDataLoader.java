...
public class UserDataLoader {
    ...
    public void postConstruct() {
        Role adminRole = new Role((long)2, "ROLE_ADMIN");
        Role userRole = new Role((long)1, "ROLE_USER");
        ...
        User user1 = new User("user1", "user1", "user1", "user1@gmail.com", Set.of(adminRole, userRole));
